...
/**
 * This is the item provider adapter for a {@link org.multicore_association.shim.model.shim.FIFOCommunication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FIFOCommunicationItemProvider extends AbstractCommunicationItemProvider {
	...
	protected void addDataSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FIFOCommunication_dataSize_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FIFOCommunication_dataSize_feature",
								"_UI_FIFOCommunication_type"),
						ShimPackage.Literals.FIFO_COMMUNICATION__DATA_SIZE, true, false, false,
	...
	protected void addDataSizeUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FIFOCommunication_dataSizeUnit_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FIFOCommunication_dataSizeUnit_feature",
								"_UI_FIFOCommunication_type"),
						ShimPackage.Literals.FIFO_COMMUNICATION__DATA_SIZE_UNIT, true, false, false,
	...
	protected void addQueueSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_FIFOCommunication_queueSize_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_FIFOCommunication_queueSize_feature",
								"_UI_FIFOCommunication_type"),
						ShimPackage.Literals.FIFO_COMMUNICATION__QUEUE_SIZE, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((FIFOCommunication) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_FIFOCommunication_type")
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FIFOCommunication.class)) {
