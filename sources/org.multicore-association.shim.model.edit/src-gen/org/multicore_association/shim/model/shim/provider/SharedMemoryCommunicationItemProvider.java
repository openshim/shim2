...
/**
 * This is the item provider adapter for a {@link org.multicore_association.shim.model.shim.SharedMemoryCommunication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SharedMemoryCommunicationItemProvider extends AbstractCommunicationItemProvider {
	...
	protected void addOperationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SharedMemoryCommunication_operationType_feature",
						"_UI_SharedMemoryCommunication_type"),
				ShimPackage.Literals.SHARED_MEMORY_COMMUNICATION__OPERATION_TYPE, true, false, false,
	...
	protected void addDataSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SharedMemoryCommunication_dataSize_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_SharedMemoryCommunication_dataSize_feature", "_UI_SharedMemoryCommunication_type"),
						ShimPackage.Literals.SHARED_MEMORY_COMMUNICATION__DATA_SIZE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDataSizeUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SharedMemoryCommunication_dataSizeUnit_feature",
						"_UI_SharedMemoryCommunication_type"),
				ShimPackage.Literals.SHARED_MEMORY_COMMUNICATION__DATA_SIZE_UNIT, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAddressSpaceRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SharedMemoryCommunication_addressSpaceRef_feature",
						"_UI_SharedMemoryCommunication_type"),
				ShimPackage.Literals.SHARED_MEMORY_COMMUNICATION__ADDRESS_SPACE_REF, true, false, true, null, null,
				null));
	}
	...
	protected void addSubSpaceRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_SharedMemoryCommunication_subSpaceRef_feature",
						"_UI_SharedMemoryCommunication_type"),
				ShimPackage.Literals.SHARED_MEMORY_COMMUNICATION__SUB_SPACE_REF, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((SharedMemoryCommunication) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_SharedMemoryCommunication_type")
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SharedMemoryCommunication.class)) {
