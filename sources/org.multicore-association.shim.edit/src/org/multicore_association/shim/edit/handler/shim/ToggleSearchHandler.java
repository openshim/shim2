...
public class ToggleSearchHandler {

	static final Logger log = ShimLoggerUtil.getLogger(ToggleSearchHandler.class);

	@Inject
	public ToggleSearchHandler() {
	}
	...
	public void execute(@Named(IServiceConstants.ACTIVE_PART) MPart part,
		...
		PartUtils.findShimEditorPart(part).ifPresent(x -> {
			performSearch(x, shell);
		});
	}

	public static void performSearch(ShimEditorPart part, Shell shell) {
		part.performSearchAction();
	}
}
