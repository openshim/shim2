 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessorImpl#getPerformanceSet <em>Performance Set</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessorImpl#getMasterComponentRef <em>Master Component Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccessorImpl extends MinimalEObjectImpl.Container implements Accessor {
	...
	public EList<PerformanceSet> getPerformanceSet() {
		if (performanceSet == null) {
			performanceSet = new EObjectContainmentEList<PerformanceSet>(PerformanceSet.class, this, ShimPackage.ACCESSOR__PERFORMANCE_SET);
		}
		...
		if (masterComponentRef != null && masterComponentRef.eIsProxy()) {
			...
			if (masterComponentRef != oldMasterComponentRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShimPackage.ACCESSOR__MASTER_COMPONENT_REF, oldMasterComponentRef, masterComponentRef));
			}
		}
	...
	public void setMasterComponentRef(MasterComponent newMasterComponentRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.ACCESSOR__MASTER_COMPONENT_REF, oldMasterComponentRef, masterComponentRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ShimPackage.ACCESSOR__MASTER_COMPONENT_REF:
				if (resolve) return getMasterComponentRef();
