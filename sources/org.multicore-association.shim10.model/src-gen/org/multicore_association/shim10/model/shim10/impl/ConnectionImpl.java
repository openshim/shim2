 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.ConnectionImpl#getPerformance <em>Performance</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.ConnectionImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.ConnectionImpl#getFrom <em>From</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectionImpl extends MinimalEObjectImpl.Container implements Connection {
	...
	public EList<Performance> getPerformance() {
		if (performance == null) {
			performance = new EObjectContainmentEList<Performance>(Performance.class, this, ShimPackage.CONNECTION__PERFORMANCE);
		}
		return performance;
	}
	...
	public MasterComponent getFrom() {
		if (from != null && from.eIsProxy()) {
			...
			if (from != oldFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShimPackage.CONNECTION__FROM, oldFrom, from));
			}
		}
		return from;
	}
