 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessTypeSetImpl#getAccessType <em>Access Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccessTypeSetImpl extends MinimalEObjectImpl.Container implements AccessTypeSet {
	...
	public EList<AccessType> getAccessType() {
		if (accessType == null) {
			accessType = new EObjectContainmentEList<AccessType>(AccessType.class, this, ShimPackage.ACCESS_TYPE_SET__ACCESS_TYPE);
		}
		return accessType;
	}
