 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AbstractCommunicationImpl#getConnectionSet <em>Connection Set</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AbstractCommunicationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractCommunicationImpl extends MinimalEObjectImpl.Container implements AbstractCommunication {
	...
	public NotificationChain basicSetConnectionSet(ConnectionSet newConnectionSet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShimPackage.ABSTRACT_COMMUNICATION__CONNECTION_SET, oldConnectionSet, newConnectionSet);
	...
	public void setConnectionSet(ConnectionSet newConnectionSet) {
		if (newConnectionSet != connectionSet) {
			...
			if (connectionSet != null)
				msgs = ((InternalEObject)connectionSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShimPackage.ABSTRACT_COMMUNICATION__CONNECTION_SET, null, msgs);
			if (newConnectionSet != null)
				msgs = ((InternalEObject)newConnectionSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShimPackage.ABSTRACT_COMMUNICATION__CONNECTION_SET, null, msgs);
			msgs = basicSetConnectionSet(newConnectionSet, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.ABSTRACT_COMMUNICATION__CONNECTION_SET, newConnectionSet, newConnectionSet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.ABSTRACT_COMMUNICATION__NAME, oldName, name));
	}
