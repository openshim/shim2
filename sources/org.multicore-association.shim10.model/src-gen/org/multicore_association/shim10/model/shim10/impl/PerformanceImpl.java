 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.PerformanceImpl#getPitch <em>Pitch</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.PerformanceImpl#getLatency <em>Latency</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.PerformanceImpl#getAccessTypeRef <em>Access Type Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PerformanceImpl extends MinimalEObjectImpl.Container implements Performance {
	...
	public NotificationChain basicSetPitch(Pitch newPitch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShimPackage.PERFORMANCE__PITCH, oldPitch, newPitch);
	...
	public void setPitch(Pitch newPitch) {
		if (newPitch != pitch) {
			...
			if (pitch != null)
				msgs = ((InternalEObject)pitch).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShimPackage.PERFORMANCE__PITCH, null, msgs);
			if (newPitch != null)
				msgs = ((InternalEObject)newPitch).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShimPackage.PERFORMANCE__PITCH, null, msgs);
	...
	public NotificationChain basicSetLatency(Latency newLatency, NotificationChain msgs) {
		...
		latency = newLatency;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ShimPackage.PERFORMANCE__LATENCY, oldLatency, newLatency);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLatency(Latency newLatency) {
		if (newLatency != latency) {
			NotificationChain msgs = null;
			if (latency != null)
				msgs = ((InternalEObject)latency).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ShimPackage.PERFORMANCE__LATENCY, null, msgs);
			if (newLatency != null)
				msgs = ((InternalEObject)newLatency).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ShimPackage.PERFORMANCE__LATENCY, null, msgs);
			msgs = basicSetLatency(newLatency, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.PERFORMANCE__LATENCY, newLatency, newLatency));
	}
	...
	public AccessType getAccessTypeRef() {
		if (accessTypeRef != null && accessTypeRef.eIsProxy()) {
			...
			if (accessTypeRef != oldAccessTypeRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShimPackage.PERFORMANCE__ACCESS_TYPE_REF, oldAccessTypeRef, accessTypeRef));
			}
		}
	...
	public void setAccessTypeRef(AccessType newAccessTypeRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.PERFORMANCE__ACCESS_TYPE_REF, oldAccessTypeRef, accessTypeRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ShimPackage.PERFORMANCE__ACCESS_TYPE_REF:
				if (resolve) return getAccessTypeRef();
