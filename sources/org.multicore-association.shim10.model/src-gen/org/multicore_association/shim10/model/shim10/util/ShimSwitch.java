	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ShimPackage.EVENT_COMMUNICATION: {
				...
				if (result == null) result = caseAbstractCommunication(eventCommunication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShimPackage.FIFO_COMMUNICATION: {
				...
				if (result == null) result = caseAbstractCommunication(fifoCommunication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ShimPackage.INTERRUPT_COMMUNICATION: {
				...
				if (result == null) result = caseAbstractCommunication(interruptCommunication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShimPackage.LATENCY: {
				...
				if (result == null) result = caseAbstractPerformance(latency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ShimPackage.PITCH: {
				...
				if (result == null) result = caseAbstractPerformance(pitch);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShimPackage.SHARED_MEMORY_COMMUNICATION: {
				...
				if (result == null) result = caseAbstractCommunication(sharedMemoryCommunication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ShimPackage.SHARED_REGISTER_COMMUNICATION: {
				...
				if (result == null) result = caseAbstractCommunication(sharedRegisterCommunication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
