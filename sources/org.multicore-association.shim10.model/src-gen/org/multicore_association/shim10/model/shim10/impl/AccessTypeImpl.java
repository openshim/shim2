 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessTypeImpl#getAccessByteSize <em>Access Byte Size</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessTypeImpl#getAlignmentByteSize <em>Alignment Byte Size</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessTypeImpl#getNBurst <em>NBurst</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.AccessTypeImpl#getRwType <em>Rw Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccessTypeImpl extends MinimalEObjectImpl.Container implements AccessType {
	 ...
	 * @ordered
	 */
	protected static final int ACCESS_BYTE_SIZE_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int accessByteSize = ACCESS_BYTE_SIZE_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final int ALIGNMENT_BYTE_SIZE_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int alignmentByteSize = ALIGNMENT_BYTE_SIZE_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final int NBURST_EDEFAULT = 0;
	 ...
	 * @ordered
	 */
	protected int nBurst = NBURST_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setAccessByteSize(int newAccessByteSize) {
		int oldAccessByteSize = accessByteSize;
		accessByteSize = newAccessByteSize;
		boolean oldAccessByteSizeESet = accessByteSizeESet;
		accessByteSizeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.ACCESS_TYPE__ACCESS_BYTE_SIZE, oldAccessByteSize, accessByteSize, !oldAccessByteSizeESet));
	}
	...
	public void unsetAccessByteSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.ACCESS_TYPE__ACCESS_BYTE_SIZE, oldAccessByteSize, ACCESS_BYTE_SIZE_EDEFAULT, oldAccessByteSizeESet));
	}
	 ...
	 * @generated
	 */
	public int getAlignmentByteSize() {
	 ...
	 * @generated
	 */
	public void setAlignmentByteSize(int newAlignmentByteSize) {
		int oldAlignmentByteSize = alignmentByteSize;
		alignmentByteSize = newAlignmentByteSize;
		boolean oldAlignmentByteSizeESet = alignmentByteSizeESet;
		alignmentByteSizeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.ACCESS_TYPE__ALIGNMENT_BYTE_SIZE, oldAlignmentByteSize, alignmentByteSize, !oldAlignmentByteSizeESet));
	}
	...
	public void unsetAlignmentByteSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.ACCESS_TYPE__ALIGNMENT_BYTE_SIZE, oldAlignmentByteSize, ALIGNMENT_BYTE_SIZE_EDEFAULT, oldAlignmentByteSizeESet));
	}
	 ...
	 * @generated
	 */
	public void setNBurst(int newNBurst) {
		int oldNBurst = nBurst;
		nBurst = newNBurst;
		boolean oldNBurstESet = nBurstESet;
		nBurstESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.ACCESS_TYPE__NBURST, oldNBurst, nBurst, !oldNBurstESet));
	}
	...
	public void unsetNBurst() {
		...
		nBurstESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.ACCESS_TYPE__NBURST, oldNBurst, NBURST_EDEFAULT, oldNBurstESet));
	}
	...
	public void setRwType(RWType newRwType) {
		...
		rwTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.ACCESS_TYPE__RW_TYPE, oldRwType, rwType, !oldRwTypeESet));
	}
	...
	public void unsetRwType() {
		...
		rwTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.ACCESS_TYPE__RW_TYPE, oldRwType, RW_TYPE_EDEFAULT, oldRwTypeESet));
	}
	...
	public String toString() {
		...
		if (accessByteSizeESet) result.append(accessByteSize); else result.append("<unset>");
		result.append(", alignmentByteSize: ");
		if (alignmentByteSizeESet) result.append(alignmentByteSize); else result.append("<unset>");
		result.append(", id: ");
		result.append(id);
		result.append(", name: ");
		result.append(name);
		result.append(", nBurst: ");
		if (nBurstESet) result.append(nBurst); else result.append("<unset>");
