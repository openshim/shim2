 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.MemoryConsistencyModelImpl#getRarOrdering <em>Rar Ordering</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.MemoryConsistencyModelImpl#getRawOrdering <em>Raw Ordering</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.MemoryConsistencyModelImpl#getWarOrdering <em>War Ordering</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.MemoryConsistencyModelImpl#getWawOrdering <em>Waw Ordering</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemoryConsistencyModelImpl extends MinimalEObjectImpl.Container implements MemoryConsistencyModel {
	 ...
	 * @ordered
	 */
	protected static final OrderingType RAR_ORDERING_EDEFAULT = OrderingType.ORDERD;
	 ...
	 * @ordered
	 */
	protected static final OrderingType RAW_ORDERING_EDEFAULT = OrderingType.ORDERD;
	 ...
	 * @ordered
	 */
	protected static final OrderingType WAR_ORDERING_EDEFAULT = OrderingType.ORDERD;
	 ...
	 * @ordered
	 */
	protected static final OrderingType WAW_ORDERING_EDEFAULT = OrderingType.ORDERD;
	...
	public void setRarOrdering(OrderingType newRarOrdering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.MEMORY_CONSISTENCY_MODEL__RAR_ORDERING, oldRarOrdering, rarOrdering, !oldRarOrderingESet));
	}
	...
	public void unsetRarOrdering() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.MEMORY_CONSISTENCY_MODEL__RAR_ORDERING, oldRarOrdering, RAR_ORDERING_EDEFAULT, oldRarOrderingESet));
	}
	...
	public void setRawOrdering(OrderingType newRawOrdering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.MEMORY_CONSISTENCY_MODEL__RAW_ORDERING, oldRawOrdering, rawOrdering, !oldRawOrderingESet));
	}
	...
	public void unsetRawOrdering() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.MEMORY_CONSISTENCY_MODEL__RAW_ORDERING, oldRawOrdering, RAW_ORDERING_EDEFAULT, oldRawOrderingESet));
	}
	...
	public void setWarOrdering(OrderingType newWarOrdering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.MEMORY_CONSISTENCY_MODEL__WAR_ORDERING, oldWarOrdering, warOrdering, !oldWarOrderingESet));
	}
	...
	public void unsetWarOrdering() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.MEMORY_CONSISTENCY_MODEL__WAR_ORDERING, oldWarOrdering, WAR_ORDERING_EDEFAULT, oldWarOrderingESet));
	}
	...
	public void setWawOrdering(OrderingType newWawOrdering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.MEMORY_CONSISTENCY_MODEL__WAW_ORDERING, oldWawOrdering, wawOrdering, !oldWawOrderingESet));
	}
	...
	public void unsetWawOrdering() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.MEMORY_CONSISTENCY_MODEL__WAW_ORDERING, oldWawOrdering, WAW_ORDERING_EDEFAULT, oldWawOrderingESet));
	}
	...
	public String toString() {
		...
		if (rarOrderingESet) result.append(rarOrdering); else result.append("<unset>");
		result.append(", rawOrdering: ");
		if (rawOrderingESet) result.append(rawOrdering); else result.append("<unset>");
		result.append(", warOrdering: ");
		if (warOrderingESet) result.append(warOrdering); else result.append("<unset>");
		result.append(", wawOrdering: ");
		if (wawOrderingESet) result.append(wawOrdering); else result.append("<unset>");
		result.append(')');
