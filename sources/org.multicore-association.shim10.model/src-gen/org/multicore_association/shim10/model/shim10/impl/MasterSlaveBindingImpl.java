 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.MasterSlaveBindingImpl#getAccessor <em>Accessor</em>}</li>
 *   <li>{@link org.multicore_association.shim10.model.shim10.impl.MasterSlaveBindingImpl#getSlaveComponentRef <em>Slave Component Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MasterSlaveBindingImpl extends MinimalEObjectImpl.Container implements MasterSlaveBinding {
	...
	public EList<Accessor> getAccessor() {
		if (accessor == null) {
			accessor = new EObjectContainmentEList<Accessor>(Accessor.class, this, ShimPackage.MASTER_SLAVE_BINDING__ACCESSOR);
		}
		return accessor;
	}
		...
		if (slaveComponentRef != null && slaveComponentRef.eIsProxy()) {
			...
			if (slaveComponentRef != oldSlaveComponentRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ShimPackage.MASTER_SLAVE_BINDING__SLAVE_COMPONENT_REF, oldSlaveComponentRef, slaveComponentRef));
			}
		}
	...
	public void setSlaveComponentRef(SlaveComponent newSlaveComponentRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.MASTER_SLAVE_BINDING__SLAVE_COMPONENT_REF, oldSlaveComponentRef, slaveComponentRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ShimPackage.MASTER_SLAVE_BINDING__SLAVE_COMPONENT_REF:
				if (resolve) return getSlaveComponentRef();
