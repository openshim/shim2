 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.SharedMemoryCommunicationImpl#getOperationType <em>Operation Type</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.SharedMemoryCommunicationImpl#getDataSize <em>Data Size</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.SharedMemoryCommunicationImpl#getDataSizeUnit <em>Data Size Unit</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.SharedMemoryCommunicationImpl#getAddressSpaceRef <em>Address Space Ref</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.SharedMemoryCommunicationImpl#getSubSpaceRef <em>Sub Space Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SharedMemoryCommunicationImpl extends AbstractCommunicationImpl implements SharedMemoryCommunication {
	 ...
	 * @ordered
	 */
	protected static final Integer DATA_SIZE_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Integer dataSize = DATA_SIZE_EDEFAULT;
	...
	public void setOperationType(OperationType newOperationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ShimPackage.SHARED_MEMORY_COMMUNICATION__OPERATION_TYPE, oldOperationType, operationType,
					!oldOperationTypeESet));
	}
	...
	public void unsetOperationType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					ShimPackage.SHARED_MEMORY_COMMUNICATION__OPERATION_TYPE, oldOperationType, OPERATION_TYPE_EDEFAULT,
					oldOperationTypeESet));
	}
	 ...
	 * @generated
	 */
	public void setDataSize(Integer newDataSize) {
		Integer oldDataSize = dataSize;
		dataSize = newDataSize;
		boolean oldDataSizeESet = dataSizeESet;
		dataSizeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShimPackage.SHARED_MEMORY_COMMUNICATION__DATA_SIZE,
					oldDataSize, dataSize, !oldDataSizeESet));
	}
	...
	public void unsetDataSize() {
		...
		dataSizeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ShimPackage.SHARED_MEMORY_COMMUNICATION__DATA_SIZE,
					oldDataSize, DATA_SIZE_EDEFAULT, oldDataSizeESet));
	}
	...
	public void setDataSizeUnit(SizeUnitType newDataSizeUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ShimPackage.SHARED_MEMORY_COMMUNICATION__DATA_SIZE_UNIT, oldDataSizeUnit, dataSizeUnit,
					!oldDataSizeUnitESet));
	}
	...
	public void unsetDataSizeUnit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET,
					ShimPackage.SHARED_MEMORY_COMMUNICATION__DATA_SIZE_UNIT, oldDataSizeUnit, DATA_SIZE_UNIT_EDEFAULT,
					oldDataSizeUnitESet));
	}
			...
			if (addressSpaceRef != oldAddressSpaceRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ShimPackage.SHARED_MEMORY_COMMUNICATION__ADDRESS_SPACE_REF, oldAddressSpaceRef,
							addressSpaceRef));
			}
		}
	...
	public void setAddressSpaceRef(AddressSpace newAddressSpaceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ShimPackage.SHARED_MEMORY_COMMUNICATION__ADDRESS_SPACE_REF, oldAddressSpaceRef, addressSpaceRef));
	}
	...
	public SubSpace getSubSpaceRef() {
		if (subSpaceRef != null && subSpaceRef.eIsProxy()) {
			...
			if (subSpaceRef != oldSubSpaceRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ShimPackage.SHARED_MEMORY_COMMUNICATION__SUB_SPACE_REF, oldSubSpaceRef, subSpaceRef));
			}
		}
		return subSpaceRef;
	}
