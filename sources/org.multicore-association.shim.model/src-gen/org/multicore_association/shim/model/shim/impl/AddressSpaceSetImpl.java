 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.AddressSpaceSetImpl#getAddressSpace <em>Address Space</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddressSpaceSetImpl extends MinimalEObjectImpl.Container implements AddressSpaceSet {
	...
	public EList<AddressSpace> getAddressSpace() {
		if (addressSpace == null) {
			addressSpace = new EObjectContainmentEList<AddressSpace>(AddressSpace.class, this,
					ShimPackage.ADDRESS_SPACE_SET__ADDRESS_SPACE);
		}
		return addressSpace;
	}
