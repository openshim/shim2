 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.CommunicationSetImpl#getSharedMemoryCommunication <em>Shared Memory Communication</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.CommunicationSetImpl#getSharedRegisterCommunication <em>Shared Register Communication</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.CommunicationSetImpl#getEventCommunication <em>Event Communication</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.CommunicationSetImpl#getFIFOCommunication <em>FIFO Communication</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.CommunicationSetImpl#getInterruptCommunication <em>Interrupt Communication</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationSetImpl extends MinimalEObjectImpl.Container implements CommunicationSet {
	...
	public EList<SharedMemoryCommunication> getSharedMemoryCommunication() {
		if (sharedMemoryCommunication == null) {
			sharedMemoryCommunication = new EObjectContainmentEList<SharedMemoryCommunication>(
					SharedMemoryCommunication.class, this, ShimPackage.COMMUNICATION_SET__SHARED_MEMORY_COMMUNICATION);
		}
	...
	public EList<SharedRegisterCommunication> getSharedRegisterCommunication() {
		if (sharedRegisterCommunication == null) {
			sharedRegisterCommunication = new EObjectContainmentEList<SharedRegisterCommunication>(
					SharedRegisterCommunication.class, this,
					ShimPackage.COMMUNICATION_SET__SHARED_REGISTER_COMMUNICATION);
		}
	...
	public EList<EventCommunication> getEventCommunication() {
		if (eventCommunication == null) {
			eventCommunication = new EObjectContainmentEList<EventCommunication>(EventCommunication.class, this,
					ShimPackage.COMMUNICATION_SET__EVENT_COMMUNICATION);
		}
	...
	public EList<FIFOCommunication> getFIFOCommunication() {
		if (fIFOCommunication == null) {
			fIFOCommunication = new EObjectContainmentEList<FIFOCommunication>(FIFOCommunication.class, this,
					ShimPackage.COMMUNICATION_SET__FIFO_COMMUNICATION);
		}
	...
	public EList<InterruptCommunication> getInterruptCommunication() {
		if (interruptCommunication == null) {
			interruptCommunication = new EObjectContainmentEList<InterruptCommunication>(InterruptCommunication.class,
					this, ShimPackage.COMMUNICATION_SET__INTERRUPT_COMMUNICATION);
		}
