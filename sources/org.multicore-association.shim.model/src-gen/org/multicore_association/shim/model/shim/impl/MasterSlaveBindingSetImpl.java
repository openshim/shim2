 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.MasterSlaveBindingSetImpl#getMasterSlaveBinding <em>Master Slave Binding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MasterSlaveBindingSetImpl extends MinimalEObjectImpl.Container implements MasterSlaveBindingSet {
	...
	public EList<MasterSlaveBinding> getMasterSlaveBinding() {
		if (masterSlaveBinding == null) {
			masterSlaveBinding = new EObjectContainmentEList<MasterSlaveBinding>(MasterSlaveBinding.class, this,
					ShimPackage.MASTER_SLAVE_BINDING_SET__MASTER_SLAVE_BINDING);
		}
