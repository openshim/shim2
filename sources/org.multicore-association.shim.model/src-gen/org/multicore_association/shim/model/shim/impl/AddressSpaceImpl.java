 ...
 * </p>
 * <ul>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.AddressSpaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.AddressSpaceImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.multicore_association.shim.model.shim.impl.AddressSpaceImpl#getSubSpace <em>Sub Space</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddressSpaceImpl extends MinimalEObjectImpl.Container implements AddressSpace {
	...
	public EList<SubSpace> getSubSpace() {
		if (subSpace == null) {
			subSpace = new EObjectContainmentEList<SubSpace>(SubSpace.class, this,
					ShimPackage.ADDRESS_SPACE__SUB_SPACE);
		}
		return subSpace;
	}
